...
\section{Proces tworzenia i dołączania kolejnego bloku z transakcjami}
...
\begin{subfigure}[b]{0.85\textwidth}
   \includegraphics[width=1\linewidth]{pictures/srednia_dlugosc_sciezki/srednia_dlugosc_sciezki_hm.png}
   \caption{}
   \label{fig:sds1} 
\end{subfigure}
\begin{subfigure}[b]{0.85\textwidth}
   \includegraphics[width=1\linewidth]{pictures/srednia_dlugosc_sciezki/srednia_dlugosc_sciezki_sda.png}
   \caption{}
   \label{fig:sds2}
\end{subfigure}
\caption[Średnia długość scieżki]{(a) mapa cieplna średniej długości scieżki w sieci dla 10 transakcji w 10 okresach (b) regresja liniowa średniej długości scieżki sieci dla 10 okresów z odchyleniem standardowym}
\end{figure}
...
\centering
\begin{subfigure}[b]{0.85\textwidth}
   \includegraphics[width=1\linewidth]{pictures/srednica/srednica_hm.png}
   \caption{}
   \label{fig:s1} 
\end{subfigure}
\begin{subfigure}[b]{0.85\textwidth}
   \includegraphics[width=1\linewidth]{pictures/srednica/srednica_sda.png}
   \caption{}
   \label{fig:s2}
\end{subfigure}
\caption[Średnia średnica sieci]{(a) mapa cieplna średniej średnicy sieci dla 10 transakcji w 10 okresach (b) regresja liniowa średniej średnicy sieci dla 10 okresów z odchyleniem standardowym}
\end{figure}
...
\begin{subfigure}[b]{0.85\textwidth}
   ...
   \label{fig:rc2}
\end{subfigure}
\caption[Średni czas różnic kolejnych transakcji]{(a) mapa cieplna średniego czasu różnic kolejnych transakcji sieci dla 10 transakcji w 10 okresach (b) regresja liniowa średniego czasu różnic kolejnych transakcji sieci dla 10 okresów z odchyleniem standardowym}
\end{figure}
...
\begin{subfigure}[b]{0.85\textwidth}
   ...
   \label{fig:ib2}
\end{subfigure}
\caption[Średnia ilość bloków potrzebna na znalezienie 100000 połączeń]{(a) mapa cieplna średniej ilości bloków sieci potrzebnych na znalezienie 100000 połączeń dla 10 transakcji w 10 okresach (b) regresja liniowa średniej ilości bloków sieci potrzebnych na znalezienie 100000 połączeń dla 10 okresów z odchyleniem standardowym}
\end{figure}
...
\begin{subfigure}[b]{0.85\textwidth}
   ...
   \label{fig:cg2}
\end{subfigure}
\caption[Średni czas różnic granicznych transakcji]{(a) mapa cieplna średniego czasu różnic granicznych transakcji dla 10 transakcji w 10 okresach (b) regresja liniowa średniego czasu różnic granicznych transakcji dla 10 okresów z odchyleniem standardowym}
\end{figure}
